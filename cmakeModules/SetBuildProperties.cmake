MACRO(SetBuildProperties projectName)
	if(UNIX)
		...
		set(LIB_CONVENTION "${RUNTIME_SUFFIX}${PLATFORM_SUFFIX}${STATIC_SUFFIX}" CACHE INTERNAL "Naming convention for release libraries")
		set(DEBUG_LIB_CONVENTION "${RUNTIME_SUFFIX}d${PLATFORM_SUFFIX}${STATIC_SUFFIX}" CACHE INTERNAL "Naming convention for debug libraries")
	endif()
ENDMACRO()